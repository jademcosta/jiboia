...
func New(l *zap.SugaredLogger, c *config.Config, metricRegistry *prometheus.Registry, flow domain.DataFlow) *Api {
	...
	//TODO: I'm using s tatic approach to be able to release it asap. In the future the route naming
...
func registerDefaultMiddlewares(api *Api, l *zap.SugaredLogger, metricRegistry *prometheus.Registry) {
	//TODO: Use our own middlewares, integrated with log package
	...
	api.mux.Use(middleware.Recoverer) //TODO: add logger for this middleware
}
